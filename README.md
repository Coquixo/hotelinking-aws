...
https://g0je6xfdfj.execute-api.eu-west-3.amazonaws.com/Prod/hotelinking

Query param added to test:

https://g0je6xfdfj.execute-api.eu-west-3.amazonaws.com/Prod/hotelinking?name=Alex
...
```bash
aws cloudformation delete-stack --stack-name give-name-app
```
